...
3. **Configure WebDriver**
   Place the WebDriver executables for your preferred browsers in the `drivers` directory.

4. **Update Configuration**
   Modify the `src/main/resources/config.properties` file to set the URL of the travel website and any other necessary configurations.
